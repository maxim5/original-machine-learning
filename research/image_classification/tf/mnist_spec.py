...
hyper_params = {
  ...
  'conv': {
    'layers_num': 3,
    1: {
      'filters': random_conv_layer(size=spec.choice(range(3, 8)), num=spec.choice(range(24, 37))),
      'pools': [2, 2],
      'activation': spec.choice(activations),
      'dropout': spec.uniform(0.85, 1.0),
    },
    2: {
      'filters': random_conv_layer(size=spec.choice(range(3, 6)), num=spec.choice(range(64, 129))),
      'pools': [2, 2],
      'activation': spec.choice(activations),
